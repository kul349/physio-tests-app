...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{`${slides[currentSlide].title} | Physio Tests`}</title>
        <meta name="description" content={slides[currentSlide].description} />

        {/* Dynamic Social Sharing */}
        <meta property="og:title" content={slides[currentSlide].title} />
        <meta
        ...
        <meta
          property="og:image"
          content={`https://physio-tests-app.vercel.app${slides[currentSlide].image}`}
        />

        {/* You can even change the theme color based on the slide's bgColor */}
                ...
                >
                  <div className="max-w-xl w-full">
                    ...
                    <div className="flex flex-col sm:flex-row items-start gap-6">
                      <Link
                        to="/page/test-details"
                        className="inline-flex items-center gap-3 px-8 py-4 bg-white text-gray-900 hover:bg-gray-100 font-medium tracking-wide rounded-full transition-all duration-300"
                      >
                        <span>GET TEST</span>
                        <GoArrowRight />
                      </Link>
                      ...
                      <a
                        ...
                        aria-label="Watch the Physiotherapy Education video" // Added for accessibility
                      >
                        <div className="relative w-14 h-14 flex items-center justify-center">
                          <div className="absolute inset-0 bg-white/15 backdrop-blur-sm rounded-full" />
                          {/* Pulse ring is decorative, hide it */}
                          <div
                            className="absolute inset-0 border-2 border-white/30 rounded-full animate-pulse-ring"
                            aria-hidden="true"
                          />
                          <svg
                            width="14"
