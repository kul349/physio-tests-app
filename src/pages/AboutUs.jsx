      ...
      <section className="relative py-20 md:py-32 overflow-hidden bg-white">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-8 leading-tight">
            Understanding your body shouldn't be{" "}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-bold text-slate-900 text-lg mb-2">Clarity</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-slate-500 leading-relaxed px-4">
                When you understand the process, you can communicate better with
                your medical team.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-600 leading-loose">
                ...
                performs a "Lachman Test" or a "Hawkins-Kennedy," most patients
                are left wondering what just happened and what the result means
                for their daily life.
              </p>
              <p className="text-lg text-slate-600 leading-loose">
                PhysioTest was created to pull back the curtain. We translate
                professional orthopedic assessments into patient-friendly guides
                so you can be an active participant in your own healing.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              We've simplified our library to focus on what matters most to you
              as a patient.
            </p>
          </div>
      ...
      <footer className="py-16 bg-white px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="max-w-3xl mx-auto text-xs text-slate-400 leading-loose uppercase tracking-tighter font-sans ">
            OrthoCheck provides educational information only. This tool is not a
