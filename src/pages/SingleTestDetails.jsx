    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 pb-20">
      ...
      <nav className="sticky top-0 z-30 bg-white/90 backdrop-blur-sm border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/page/test-details" className="flex items-center gap-2 text-slate-500 hover:text-emerald-600 transition-colors text-sm font-semibold">
            <ChevronLeft size={18} />
      ...
      <main className="max-w-4xl mx-auto px-6 mt-12">
        ...
        <section className="bg-rose-50 border border-rose-100 p-8 rounded-3xl mb-16">
          ...
          <p className="text-sm text-rose-700 leading-relaxed">
            ...
            pain, swelling, or can't put weight on your leg, please visit an
